        ...
        <>
            <div className="item-row">
                ...
                <div className="action-buttons">
                    <button style={{ marginRight: '5px' }} onClick={() => isBeingEdited ? saveItem() : setIsBeingEdited(!isBeingEdited)}>{isBeingEdited ? <FontAwesomeIcon icon={faSave}></FontAwesomeIcon> : <FontAwesomeIcon icon={faEdit}></FontAwesomeIcon>} </button>
                    <button disabled={isBeingEdited} onClick={() => onRemoveClick(item)}><FontAwesomeIcon icon={faRemove}></FontAwesomeIcon></button>
                </div>
            </div>
        </>
    )
