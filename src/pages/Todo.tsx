...
import logo from '../assets/montel.png'
            ...
            <div className="todo-container">
                <ThemeProvider theme={createMaterialTheme()}>
                    <FormControl variant="standard">
                        ...
                        <Select className="filter-select" onChange={handleFilterSelectionChange} sx={{ color: "white" }} labelId="select-filter-label" id="select-filter" value={listFilter}>
                ...
                <div className="new-item-container">
                    ...
                    <button disabled={newItemText.length < 1} onClick={addNewItem} className="add-new-button"><FontAwesomeIcon icon={faPlus}></FontAwesomeIcon></button>
